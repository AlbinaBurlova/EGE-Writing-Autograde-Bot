...
В качестве инструмента тестирования была использована библиотека aiogram_tests, точнее её улучшенная версия. Все авторские права остаются за создателями библиотеки. Для собственного удобства была добавлена функция, возвращающая последний запрос сессии бота:
```
